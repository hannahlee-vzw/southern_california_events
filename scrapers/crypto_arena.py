...
Rendering: JavaScript (AXS / Ticketmaster).
Strategy: Playwright headless Chromium.

TODO (after inspecting live site):
  - Confirm the correct domain (cryptoarena.com vs cryptocom-arena.com).
  - Confirm CSS selectors for event cards, title, date, time, link.
  - Check for pagination or infinite scroll and handle accordingly.
"""
